...
<head>
    ...
    @vite('resources/css/stylelogada.css')
</head>
<body>
    <header>
        <nav>
        ...
        <img src="../css/icone_usuario.png" alt="Ícone de Usuário" class="user-icon" onclick="openUserPanel()">
    </header>
    ...
    <div id="userPanel" class="user-panel">
        ...
        <div class="user-panel-header">
            ...
            <img src="../css/icone_usuario.png" alt="Ícone de Usuário" class="user-icon">
        </div>
    ...
    <script src="../js/scriptlogada.js"></script>
</body>
</html>